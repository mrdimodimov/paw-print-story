...
MEMORY TITLES: Each paragraph should work as a distinct memory chapter with a cinematic 3–6 word title. Derive titles from places, behaviors, sensory details, or turning points — never generic phrases. Do NOT use dashes or decorative symbols in the prose.
