...
export const TIERS: TierConfig[] = [
  {
    ...
    name: "Simple Tribute",
    price: 19,
    label: "For quick, simple goodbyes",
  ...
  },
  {
    ...
    price: 39,
    popular: true,
    description: "Their quirks, their rituals, the moments only you knew — woven into a full story with photos you can share and keep forever.",
    micro_text: "Most pet parents choose this to preserve their pet's memory",
    word_count_target: [450, 600],
    features: [
      "Complete tribute story with memories",
      "Photo gallery (up to 3 photos)",
      "Shareable memorial page",
      "Social media tribute card",
      "Printable memorial (digital download)",
    ],
    include_share_card: true,
