...
export const TIERS: TierConfig[] = [
  {
    ...
    name: "Quick Tribute",
    price: 19,
    description: "Best for writing a simple memorial story.",
    word_count_target: [350, 450],
    features: [
      "Tribute story",
      "One photo",
      "Private tribute page",
  ...
  },
  {
    ...
    price: 39,
    popular: true,
    description: "Create a beautiful tribute and keepsake to share.",
    micro_text: "Most pet parents choose this option to preserve their pet's memory.",
  ...
  },
  {
    ...
    description: "A permanent online memorial for your pet.",
    word_count_target: [500, 650],
    features: [
      "Everything in Memorial Tribute Pack",
      "Custom tribute page URL",
      "Public memorial option",
