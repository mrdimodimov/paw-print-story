...
const DachshundMemorialQuotes = () => (
  <SeoArticleLayout
    slug="/dachshund-memorial-quotes"
    ...
    exampleTitle="Short Dachshund Quotes"
    exampleBody={[
      '"Long body, longer love."',
      '"You were braver than you looked."',
    ...
    howToWriteBody={[
      '"You may have been small, but you filled every inch of my life with love."',
      '"I miss you burrowing under the blankets beside me."',
...
export default DachshundMemorialQuotes;
