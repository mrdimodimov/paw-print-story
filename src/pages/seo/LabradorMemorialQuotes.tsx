...
const LabradorMemorialQuotes = () => (
  <SeoArticleLayout
    slug="/labrador-memorial-quotes"
    ...
    exampleTitle="Short Labrador Quotes"
    exampleBody={[
      '"You were sunshine in dog form."',
    ...
    howToWriteBody={[
      '"You taught me that joy is simple — a ball, a walk, and someone to love."',
      '"The house feels emptier without your paws on the floor."',
...
export default LabradorMemorialQuotes;
