...
const PetRemembranceQuotes = () => (
  <SeoArticleLayout
    ...
    tips={[
      {
        heading: "Start with a sensory detail",
        body: "The sound of their breathing, the weight of them in your arms, the warmth of them beside you — sensory memories are the most vivid and emotional.",
      },
      {
        heading: "Use their name",
        body: "A quote that includes your pet's name becomes instantly personal. 'I miss you, Pepper' carries more weight than any general sentiment.",
      },
      {
        heading: "Keep it universal yet personal",
        body: "The best remembrance quotes feel specific to your pet but resonate with anyone who has loved and lost an animal companion.",
      },
      {
        heading: "Match the tone to your relationship",
        body: "If your pet was playful, let the quote reflect that. If they were calm and quiet, let the words be gentle. The quote should sound like them.",
      },
      {
        heading: "Use it somewhere meaningful",
        body: "A remembrance quote gains power when placed — on a memorial page, in a frame, on a stone in the garden. Give your words a home.",
      },
    ]}
    ...
    faqs={[
      { question: "What are pet remembrance quotes?", answer: "Pet remembrance quotes are short, meaningful phrases used to honour a pet's memory. They work for any type of pet and can be used in tributes, cards, or keepsakes." },
      { question: "How are remembrance quotes different from memorial quotes?", answer: "They're very similar. Remembrance quotes tend to focus on keeping memories alive, while memorial quotes may focus more on grief and tribute." },
      { question: "Can I use these for any type of pet?", answer: "Yes. Pet remembrance quotes are universal and can honour dogs, cats, rabbits, birds, horses, and any animal companion." },
...
export default PetRemembranceQuotes;
