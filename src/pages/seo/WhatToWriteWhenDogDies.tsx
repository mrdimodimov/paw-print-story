...
const WhatToWriteWhenDogDies = () => (
  <SeoArticleLayout
    ...
    tips={[
      "Start by writing down the first memory that comes to mind — don't overthink it.",
      "Describe your dog's daily routines and the role they played in your life.",
      "Include the funny moments alongside the tender ones — pets bring both.",
      "Write as if you're telling a friend about your dog. Keep it conversational and warm.",
