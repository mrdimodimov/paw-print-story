...
const WhatToWriteWhenDogDies = () => (
  <SeoArticleLayout
    ...
    faqs={[
      ...
      { question: "Can I use quotes?", answer: "Yes. Short quotes work well in cards, social media, or memorial pages." },
      { question: "What makes a good tribute?", answer: "Personal and meaningful content that captures your dog's unique personality." },
